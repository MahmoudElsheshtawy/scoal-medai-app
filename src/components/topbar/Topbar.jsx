...
export default function Topbar() {
  ...
  return (
    <div className="topbarContainer" >
      <div className="topbarLeft" style={{display:"flex" ,alignItems:'center',marginRight:'5px'}}>
             <span className="logo" style={{padding:'7px',fontSize:'20px',marginRight:'15px'}}><a href='#top' style={{textDecoration:'none',fontWeight:'bold',color:'#fff'}}>SH</a></span>
      ...
      <div className="topbarRight" style={{ display:'flex' ,alignItems:'center',justifyContent:'flex-end'}}>
                ...
                <div className="links" style={{display:'flex',alignItems:'center',position:'relative'}}> 
                <NotificationsIcon onClick={()=>setNav(!nav)} className="icon-right"/>
              
                <span className="not1">7</span>

                  <MessageIcon onClick={()=>setNav(!nav)} className="icon-right"/>
                  <span className="not2">5</span>
             
                  <PersonIcon onClick={()=>setNav(!nav)} className="icon-right"/>
                  <span className="not3">1</span>
